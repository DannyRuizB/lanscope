...
services:
  lanscope:
    image: ghcr.io/dannyruizb/lanscope:0.10.1
...
Pin a specific version (`:0.10.1`) in production so upgrades are intentional. Use `:latest` if you actively want to track the newest release.
