...
services:
  lanscope:
    image: ghcr.io/dannyruizb/lanscope:0.11.0
...
Pin a specific version (`:0.11.0`) in production so upgrades are intentional. Use `:latest` if you actively want to track the newest release.
